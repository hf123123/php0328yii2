...
<div class="topnav">
    <div class="topnav_bd w990 bc">
        ...
        <div class="topnav_right fr">
            <ul>
                <li>您好，欢迎来到京西！[<a href="http://www.yiishop.com/user/login">登录</a>] [<a href="http://www.yiishop.com/user/register">免费注册</a>] </li>0
                <li class="line">|</li>
                <li>我的订单</li>
                <li class="line">|</li>
                <li>客户服务</li>
...
<div class="mycart w990 mt10 bc">
    ...
    <div class="cart_btn w990 bc mt10">
        ...
        <?=\yii\helpers\Html::a('结算',['goods/order'],['class'=>'checkout'])?>
    </div>
</div>
<!-- 主体部分 end -->
