...
<div class="topnav">
    <div class="topnav_bd w1210 bc">
        ...
        <div class="topnav_right fr">
            <ul>
                <li>您好，欢迎来到京西！[<a href="http://www.yiishop.com/user/login">登录</a>] [<a href="http://www.yiishop.com/user/register">免费注册</a>] </li>
                <li class="line">|</li>
                <li>我的订单</li>
                <li class="line">|</li>
                <li>客户服务</li>
    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl"> <!-- 非首页，需要添加cat1类 -->
            ...
            <?php foreach($model as $v):?>
                <div class="cat">
                    <?php if($v->depth==0){
                        echo '<h3><a href="">'.$v->name.'</a><b></b></h3>';
                    }?>
                                ...
                                foreach($m as $n){
                                    ...
                                    if(\backend\models\GoodsCategory::find()->where('parent_id='.$n->id)->all()){
                                        foreach(\backend\models\GoodsCategory::find()->where('parent_id='.$n->id)->all() as $c){
                                            echo '<dd><a href="/goods/list?id='.$c->id.'">'.$c->name.'</a></dd>';
                                        }
                                    }
                                }
